...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界4-困难
    {
        waves: [
            {
                enemies: [{ type: 1020, count: 5, spawnInterval: 5, gate: 1 }],
                waveGold: 200,
                waveTime: 30,
                hpMultiplier: 2.7,
            },
            {
                enemies: [{ type: 1025, count: 5, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 5.4,
            },
            {
                enemies: [{ type: 1022, count: 5, spawnInterval: 5, gate: 1 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 8.1,
            },
            ...
            {
                enemies: [{ type: 1023, count: 3, spawnInterval: 5, gate: 1 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 8.1,
            },
