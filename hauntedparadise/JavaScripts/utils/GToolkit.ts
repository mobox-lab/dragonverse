...
//#region Data Storage
     ...
     */
    public async queryOtherSceneModuleData(moduleDataName: string, userId: string, defaultValue: string = ""): Promise<string> {
     ...
     */
    public async updateOtherSceneModuleData(moduleDataName: string, userId: string, value: string): Promise<boolean> {
