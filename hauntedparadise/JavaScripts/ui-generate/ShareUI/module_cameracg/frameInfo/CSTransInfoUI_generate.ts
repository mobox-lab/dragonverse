 ...
 @UIBind('UI/ShareUI/module_cameracg/frameInfo/CSTransInfoUI.ui')
 export default class CSTransInfoUI_Generate extends UIScript {
...
UIService['UI_CSTransInfoUI'] = CSTransInfoUI_Generate;