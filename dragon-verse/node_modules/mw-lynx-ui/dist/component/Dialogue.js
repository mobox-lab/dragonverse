...
class Dialogue extends Component {
    ...
    static create(option) {
        ...
        dialogue.onAttach.add(() => {
            ...
            Gtk.setUiPosition(dialogue.root, (viewPortSize.x - dialogue.root.size.x) / 2
                + (viewPortAbsPos.x - posParAbs.x) / mw.getViewportScale(), (viewPortSize.y - dialogue.root.size.y) / 2
