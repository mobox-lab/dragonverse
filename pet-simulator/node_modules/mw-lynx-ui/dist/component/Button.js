...
class Button extends Component {
    constructor() {
        ...
        this.renderAnimHandler = (dt) => {
            if (!this._btn.enable && this._imgClickAnim.renderOpacity < 1) {
                Gtk.setUiPosition(this._imgClickAnim, (this._option.padding.left ?? 0) - this._imgClickAnim.size.x / 2, (this._option.padding.top ?? 0) - this._imgClickAnim.size.y / 2);
    ...
    static create(option) {
        ...
        if (btn._option.variant === "contained") {
            ...
            btn._btn.normalImageMargin = new mw.Margin(Lui.Asset.ImgRoundedRectangleBoxMargin.left, Lui.Asset.ImgRoundedRectangleBoxMargin.top, Lui.Asset.ImgRoundedRectangleBoxMargin.right, Lui.Asset.ImgRoundedRectangleBoxMargin.bottom);
        }
        ...
        Gtk.trySetVisibility(btn._txtLabel, Gtk.isNullOrEmpty(btn._option.icon) && !btn._option.renderIcon);
        ...
        if (!Gtk.isNullOrEmpty(btn._option.label))
            Gtk.trySetText(btn._txtLabel, btn._option.label);
        btn._cnvIcon = mw.Canvas.newObject(btn.root, "cnvIcon");
        Gtk.trySetVisibility(btn._cnvIcon, !Gtk.isNullOrEmpty(btn._option.icon) || !!btn._option.renderIcon);
        ...
        if (hasCorner(btn._option.corner, Property.Corner.All)) {
            ...
            btn._imgHighlight.margin = new mw.Margin(Lui.Asset.ImgRoundedRectangleBoxMargin.left, Lui.Asset.ImgRoundedRectangleBoxMargin.top, Lui.Asset.ImgRoundedRectangleBoxMargin.right, Lui.Asset.ImgRoundedRectangleBoxMargin.bottom);
        }
        ...
        btn._btn.onClicked.add(() => {
            const clickAt = mw.absoluteToLocal(btn.root.cachedGeometry, mw.getMousePositionOnPlatform());
        ...
        btn._btn.onHovered.add(() => {
            if (btn._imgClickAnim.renderOpacity <= 0)
                btn._hovered = true;
        });
    ...
    preview() {
        ...
        Gtk.setUiPosition(this._imgClickAnim, this._cnvClickAnim.size.x - this._imgClickAnim.size.x / 2, this._cnvClickAnim.size.y - this._imgClickAnim.size.y / 2);
    ...
    setSize() {
        ...
        Gtk.setUiPosition(this._txtLabel, pl + 2 * Lui.Asset.ImgRoundedRectangleBoxMargin.left, pt);
        Gtk.setUiSize(this._txtLabel, txtSize.x, txtSize.y);
        Gtk.setUiPosition(this._cnvClickAnim, pl, pt);
        Gtk.setUiSize(this._cnvClickAnim, realBtnSize.x, realBtnSize.y);
        let minContent = Math.min(contentX, contentY);
        Gtk.setUiPosition(this._cnvIcon, pl + (contentX - minContent) / 2, pt + (contentY - minContent) / 2);
        ...
        if (this._option.renderIcon) {
            Gtk.setUiPosition(this._option.renderIcon, pl + (contentX - minContent) / 2, pt + (contentY - minContent) / 2);
            Gtk.setUiSize(this._option.renderIcon, minContent, minContent);
        }
        Gtk.setUiPosition(this._imgHighlight, pl, pt);
        Gtk.setUiSize(this._imgHighlight, realBtnSize.x, realBtnSize.y);
