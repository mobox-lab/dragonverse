...
10000＜总能力值 -- 龙龙2阶收益buff + 龙龙2阶攻击buff */
	...
	/**1. 每30分钟，根据玩家品质最高、特殊化程度最高的5只宠物恢复体力，宠物的品质维度：普通=1，稀有=2；史诗=3，传说=4，神话=5，宠物的特殊化维度：普通=0，爱心=1，彩虹=2。
2. 品质、特殊化两者取和。单次恢复体力的上限为30点。
3. 当现有体力达到体力上限时，将不再随时间恢复体力。*/
