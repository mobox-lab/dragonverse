...
export class PetBagModuleData extends Subdata {
     ...
     * @param name 宠物名字
    */
    public addBagItem(id: number, atk: number, name: string): boolean {
    ...
    public sortBag(): petItemDataNew[] {
        ...
        arr.sort((a, b) => {
            index_1 = this.curEquipPet.findIndex((value) => { return value == a.k });
            index_2 = this.curEquipPet.findIndex((value) => { return value == b.k });
            if (index_1 > 0) {
                index_1 = 0;
            }
            if (index_2 > 0) {
