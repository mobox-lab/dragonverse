...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**灵敏度*/
	get UI_49():ILanguageElement{return this.getElement(20620)};
	/**该单位会提升范围内己方单位{0}攻击力*/
	get StrategyDesc_11():ILanguageElement{return this.getElement(20621)};
