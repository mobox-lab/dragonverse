...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**WSAD键控制前后左右*/
	get Guide0001():ILanguageElement{return this.getElement(300045)};
	/**持续按住Alt键唤出鼠标*/
	get Guide0002():ILanguageElement{return this.getElement(300046)};
	/**持续按住Shift键加速*/
	get Guide0003():ILanguageElement{return this.getElement(300047)};
	/**空格键控制跳跃*/
	get Guide0004():ILanguageElement{return this.getElement(300048)};
	/**连续按空格键可以连续跳跃*/
	get Guide0005():ILanguageElement{return this.getElement(300049)};
