...
@UIBind('UI/Hover_Bag/Hover_number3.ui')
export default class Hover_number3_Generate extends UIScript {
		private can_Hover3_Internal: mw.Canvas
	public get can_Hover3(): mw.Canvas {
		if(!this.can_Hover3_Internal&&this.uiWidgetBase) {
			this.can_Hover3_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3') as mw.Canvas
		}
		return this.can_Hover3_Internal
	}
	private mPetInfo_Internal: mw.Canvas
	public get mPetInfo(): mw.Canvas {
		if(!this.mPetInfo_Internal&&this.uiWidgetBase) {
			this.mPetInfo_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo') as mw.Canvas
		}
	...
	public get mNamecanvas(): mw.Canvas {
		if(!this.mNamecanvas_Internal&&this.uiWidgetBase) {
			this.mNamecanvas_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo/mNamecanvas') as mw.Canvas
		}
	...
	public get mNameBig(): mw.TextBlock {
		if(!this.mNameBig_Internal&&this.uiWidgetBase) {
			this.mNameBig_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo/mNamecanvas/mNameBig') as mw.TextBlock
		}
	...
	public get mNameSmall(): mw.TextBlock {
		if(!this.mNameSmall_Internal&&this.uiWidgetBase) {
			this.mNameSmall_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo/mNamecanvas/mNameSmall') as mw.TextBlock
		}
	...
	public get mTypecanvas(): mw.Canvas {
		if(!this.mTypecanvas_Internal&&this.uiWidgetBase) {
			this.mTypecanvas_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo/mTypecanvas') as mw.Canvas
		}
	...
	public get picRarity(): mw.Image {
		if(!this.picRarity_Internal&&this.uiWidgetBase) {
			this.picRarity_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo/mTypecanvas/picRarity') as mw.Image
		}
	...
	public get textRarity(): mw.TextBlock {
		if(!this.textRarity_Internal&&this.uiWidgetBase) {
			this.textRarity_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo/mTypecanvas/picRarity/textRarity') as mw.TextBlock
		}
	...
	public get picLovelovelove(): mw.Image {
		if(!this.picLovelovelove_Internal&&this.uiWidgetBase) {
			this.picLovelovelove_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo/mTypecanvas/picLovelovelove') as mw.Image
		}
	...
	public get picRainbowowow(): mw.Image {
		if(!this.picRainbowowow_Internal&&this.uiWidgetBase) {
			this.picRainbowowow_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mPetInfo/mTypecanvas/picRainbowowow') as mw.Image
		}
	...
	public get mScrollBox_Entry(): mw.ScrollBox {
		if(!this.mScrollBox_Entry_Internal&&this.uiWidgetBase) {
			this.mScrollBox_Entry_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mScrollBox_Entry') as mw.ScrollBox
		}
	...
	public get mCanvas_Entrylist(): mw.Canvas {
		if(!this.mCanvas_Entrylist_Internal&&this.uiWidgetBase) {
			this.mCanvas_Entrylist_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/can_Hover3/mScrollBox_Entry/mCanvas_Entrylist') as mw.Canvas
		}
