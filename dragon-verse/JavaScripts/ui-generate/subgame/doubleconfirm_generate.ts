 ...
 * @LviatYi
 * @version 31.4.0
 * UI: UI/subgame/doubleconfirm.ui
 */

import UIScript = mw.UIScript;


@UIBind('UI/subgame/doubleconfirm.ui')
export default class doubleconfirm_Generate extends UIScript {
	...
	private codeButtonNo_Internal: mw.StaleButton
	public get codeButtonNo(): mw.StaleButton {
		if(!this.codeButtonNo_Internal&&this.uiWidgetBase) {
			this.codeButtonNo_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/doublechec/codeButtonNo') as mw.StaleButton
		}
		return this.codeButtonNo_Internal
	}
    ...
    protected initTextLan() {
        ...
        this.initLanguage(this.codeButtonNo);
        this.codeButtonNo.onClicked.add(() => Event.dispatchToLocal("__BUTTON_CLICKED__"));
    ...
    protected unregisterTextLan(){
        ...
        this.unregisterLanKey(this.codeButtonNo);
