...
class Box extends Component {
    ...
    static create(option) {
        ...
        box._imgMain.constraints = new mw.UIConstraintAnchors(mw.UIConstraintHorizontal.LeftRight, mw.UIConstraintVertical.TopBottom);
        box._imgMain.imageGuid = Lui.Asset.ImgRoundedRectangle;
        box._imgMain.imageDrawType = mw.SlateBrushDrawType.PixcelBox;
        box._imgMain.margin = new mw.Margin(Lui.Asset.ImgRoundedRectangleBoxMargin.left, Lui.Asset.ImgRoundedRectangleBoxMargin.top, Lui.Asset.ImgRoundedRectangleBoxMargin.right, Lui.Asset.ImgRoundedRectangleBoxMargin.bottom);
        if (PropertyUtil.hasCorner(box._option.corner, Property.Corner.TopLeft)) {
            ...
            box._imgTopLeft.constraints = new mw.UIConstraintAnchors(mw.UIConstraintHorizontal.Left, mw.UIConstraintVertical.Top);
        ...
        if (PropertyUtil.hasCorner(box._option.corner, Property.Corner.TopRight)) {
            ...
            box._imgTopRight.constraints = new mw.UIConstraintAnchors(mw.UIConstraintHorizontal.Right, mw.UIConstraintVertical.Top);
        ...
        if (PropertyUtil.hasCorner(box._option.corner, Property.Corner.BottomLeft)) {
            ...
            box._imgBottomLeft.constraints = new mw.UIConstraintAnchors(mw.UIConstraintHorizontal.Left, mw.UIConstraintVertical.Bottom);
        ...
        if (PropertyUtil.hasCorner(box._option.corner, Property.Corner.BottomRight)) {
            ...
            box._imgBottomRight.constraints = new mw.UIConstraintAnchors(mw.UIConstraintHorizontal.Right, mw.UIConstraintVertical.Bottom);
    ...
    setLayout(option) {
        ...
        if (this._imgTopLeft) {
            Gtk.setUiSize(this._imgTopLeft, Lui.Asset.ImgRoundedRectangleBoxMargin.left, Lui.Asset.ImgRoundedRectangleBoxMargin.top);
            Gtk.setUiPosition(this._imgTopLeft, pl, pt);
        }
        if (this._imgTopRight) {
            Gtk.setUiSize(this._imgTopRight, Lui.Asset.ImgRoundedRectangleBoxMargin.right, Lui.Asset.ImgRoundedRectangleBoxMargin.top);
            Gtk.setUiPosition(this._imgTopRight, pl + contentX - Lui.Asset.ImgRoundedRectangleBoxMargin.right, pt);
        }
        if (this._imgBottomLeft) {
            Gtk.setUiSize(this._imgBottomLeft, Lui.Asset.ImgRoundedRectangleBoxMargin.left, Lui.Asset.ImgRoundedRectangleBoxMargin.bottom);
            Gtk.setUiPosition(this._imgBottomLeft, pl, pt + contentY - Lui.Asset.ImgRoundedRectangleBoxMargin.bottom);
        }
        if (this._imgBottomRight) {
            Gtk.setUiSize(this._imgBottomRight, Lui.Asset.ImgRoundedRectangleBoxMargin.right, Lui.Asset.ImgRoundedRectangleBoxMargin.bottom);
            Gtk.setUiPosition(this._imgBottomRight, pl + contentX - Lui.Asset.ImgRoundedRectangleBoxMargin.right, pt + contentY - Lui.Asset.ImgRoundedRectangleBoxMargin.bottom);
        }
        return this;
    }
    //#endregion ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠐⠒⠒⠒⠒⠚⠛⣿⡟⠄⠄⢠⠄⠄⠄⡄⠄⠄⣠⡶⠶⣶⠶⠶⠂⣠⣶⣶⠂⠄⣸⡿⠄⠄⢀⣿⠇⠄⣰⡿⣠⡾⠋⠄⣼⡟⠄⣠⡾⠋⣾⠏⠄⢰⣿⠁⠄⠄⣾⡏⠄⠠⠿⠿⠋⠠⠶⠶⠿⠶⠾⠋⠄⠽⠟⠄⠄⠄⠃⠄⠄⣼⣿⣤⡤⠤⠤⠤⠤⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
