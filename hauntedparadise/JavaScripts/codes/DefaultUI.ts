...
// 			let attachGo = await GameObject.asyncSpawn("182181");
// 			let char = player.character;
//
// 			char.attachToSlot(attachGo, mw.HumanoidSlotType.LeftHand);
//
// 			attachGo.localTransform.rotation = Rotation.zero;
// 			attachGo.localTransform.position = Vector.zero;
// 		})
//
// 		//点击跳跃按钮,异步获取人物后执行跳跃
...
// 				this.Character = player.character;
// 				//让动画只在上半身播放
// 				let anim1 = PlayerManagerExtension.loadAnimationExtesion(player.character, "61245");
...
// 				this.Character = player.character;
// 				//让动画只在上半身播放
// 				let anim2 = PlayerManagerExtension.loadAnimationExtesion(player.character, "95777");
