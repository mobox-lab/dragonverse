...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**迷宮將引導你。但首先，你需要克服雲之障礙。記住，水火乃相生相克之物。*/
	...
	/**在這片大陸，火與水相生相克，水元素擁有淨化火元素的能力，相反亦是如此。*/
