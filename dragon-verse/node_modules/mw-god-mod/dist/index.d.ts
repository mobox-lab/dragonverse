declare module "mw-god-mod" {
    ...
    export type InferParamType<P> = P extends "void" ? void : P extends "string" ? string : P extends "number" ? number : P extends "integer" ? number : P extends "vector" ? mw.Vector : never;
