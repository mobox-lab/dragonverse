 ...
 @UIBind('UI/ShareUI/hall/En_npctalk_UI.ui')
 export default class En_npctalk_UI_Generate extends UIScript {
	...
	public get txtcontent(): mw.TextBlock {
		if(!this.txtcontent_Internal&&this.uiWidgetBase) {
			this.txtcontent_Internal = this.uiWidgetBase.findChildByPath('mRootCanvas/canvas/txtcontent') as mw.TextBlock
		}
...
UIService['UI_En_npctalk_UI'] = En_npctalk_UI_Generate;