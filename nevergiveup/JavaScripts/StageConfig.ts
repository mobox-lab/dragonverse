...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界1-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1027, count: 20, spawnInterval: 2 }],
                waveGold: 120,
                waveTime: 60,
                hpMultiplier: 0.6,
            },
    ...
    // 世界2-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1009, count: 10, spawnInterval: 4 }],
                waveGold: 100,
                waveTime: 50,
                hpMultiplier: 1.5,
            },
            {
                enemies: [{ type: 1011, count: 10, spawnInterval: 4 }],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 1.5,
            },
    ...
    // 世界2-困难
    {
        waves: [
            ...
            {
                enemies: [{ type: 1015, count: 15, spawnInterval: 2 }],
                waveGold: 100,
                waveTime: 20,
                hpMultiplier: 1.8,
            },
            {
                enemies: [{ type: 1012, count: 1, spawnInterval: 10 }],
                waveGold: 50,
                waveTime: 10,
                hpMultiplier: 8,
            },
            {
                enemies: [{ type: 1009, count: 6, spawnInterval: 4 }],
                waveGold: 0,
                waveTime: 20,
                hpMultiplier: 2,
            },
            ...
            {
                enemies: [{ type: 1015, count: 40, spawnInterval: 1 }],
                waveGold: 0,
                waveTime: 15,
                hpMultiplier: 2,
            },
            ...
            {
                enemies: [{ type: 1017, count: 10, spawnInterval: 2 }],
                waveGold: 50,
                waveTime: 15,
                hpMultiplier: 4,
            },
            ...
            {
                enemies: [{ type: 1019, count: 1, spawnInterval: 10 }],
                waveGold: 150,
                waveTime: 200,
                hpMultiplier: 40,
            },
    ...
    // 世界3-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1032, count: 1, spawnInterval: 10 }],
                waveGold: 150,
                waveTime: 500,
                hpMultiplier: 6,
            },
    ...
    // 世界3-困难
    {
        waves: [
            ...
            {
                enemies: [{ type: 1008, count: 20, spawnInterval: 2 }],
                waveGold: 150,
                waveTime: 20,
                hpMultiplier: 2,
            },
    ...
    // 世界4-普通
    {
        waves: [
            {
                enemies: [{ type: 1015, count: 15, spawnInterval: 3, gate: 0 },{ type: 1025, count: 9, spawnInterval: 5, gate: 1 }],
                waveGold: 300,
                waveTime: 40,
                hpMultiplier: 1,
            },
            {
                enemies: [{ type: 1025, count: 10, spawnInterval: 3, gate: 0 }],
                waveGold: 150,
                waveTime: 20,
                hpMultiplier: 2,
            },
            {
                enemies: [{ type: 1017, count: 5, spawnInterval: 4, gate: 0 },{ type: 1018, count: 5, spawnInterval: 4, gate: 1 }],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 2,
            },
            {
                enemies: [{ type: 1019, count: 3, spawnInterval: 10, gate: 0 },{ type: 1017, count: 4, spawnInterval: 5, gate: 1 }],
                waveGold: 100,
                waveTime: 25,
                hpMultiplier: 2,
            },
    ...
    // 世界4-困难
    {
        waves: [
            ...
            {
                enemies: [{ type: 1029, count: 4, spawnInterval: 8, gate: 0},{ type: 1023, count: 2, spawnInterval: 12, gate: 1}],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 2,
            },
            ...
            {
                enemies: [{ type: 1027, count: 20, spawnInterval: 3, gate: 0 },{ type: 1028, count: 5, spawnInterval: 10, gate: 1}],
                waveGold: 150,
                waveTime: 40,
                hpMultiplier: 3,
            },
            {
                enemies: [{ type: 1032, count: 2, spawnInterval: 20, gate: 0 },{ type: 1031, count: 1, spawnInterval: 30, gate: 1}],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 5,
            },
            ...
            {
                enemies: [{ type: 1021, count: 15, spawnInterval: 2, gate: 0 },{ type: 1011, count: 10, spawnInterval: 4, gate: 1}],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 3.5,
            },
            {
                enemies: [{ type: 1014, count: 1, spawnInterval: 10, gate: 0 }],
                waveGold: 0,
                waveTime: 5,
                hpMultiplier: 8,
            },
    ...
    // 世界5-简单
    {
        waves: [
            ...
            {
                enemies: [{ type: 1033, count: 1, spawnInterval: 5 , gate: 0},{ type: 1033, count: 1, spawnInterval: 5 , gate: 1}],
                waveGold: 100,
                waveTime: 10,
                hpMultiplier: 4,
            },
            {
                enemies: [{ type: 1031, count: 1, spawnInterval: 5 , gate: 0},{ type: 1031, count: 1, spawnInterval: 5 , gate: 1}],
                waveGold: 0,
                waveTime: 10,
                hpMultiplier: 2.2,
            },
            {
                enemies: [{ type: 1034, count: 15, spawnInterval: 3, gate: 0 },{ type: 1034, count: 15, spawnInterval: 3, gate: 1 }],
                waveGold: 100,
                waveTime: 40,
                hpMultiplier: 2.5,
            },
    ...
    // 世界5-普通
    {
        waves: [
            {
                enemies: [{ type: 1030, count: 25, spawnInterval: 2, gate: 0 },{ type: 1034, count: 8, spawnInterval: 5, gate: 1 }],
                waveGold: 400,
                waveTime: 30,
                hpMultiplier: 1.2,
            },
            {
                enemies: [{ type: 1018, count: 10, spawnInterval: 5, gate: 0 },{ type: 1019, count: 1, spawnInterval: 20, gate: 1 }],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 2,
            },
            {
                enemies: [{ type: 1033, count: 15, spawnInterval: 4 , gate: 0 },{ type: 1034, count: 10, spawnInterval: 3, gate: 1 }],
                waveGold: 100,
                waveTime: 40,
                hpMultiplier: 1.6,
            },
            {
                enemies: [{ type: 1016, count: 10, spawnInterval: 3, gate: 0 },{ type: 1016, count: 10, spawnInterval: 3, gate: 1 }],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 1.8,
            },
            {
                enemies: [{ type: 1032, count: 1, spawnInterval: 3, gate: 0 },{ type: 1032, count: 1, spawnInterval: 3, gate: 1 }],
                waveGold: 100,
                waveTime: 20,
                hpMultiplier: 3,
            },
            {
                enemies: [{ type: 1031, count: 1, spawnInterval: 3, gate: 0 },{ type: 1037, count: 1, spawnInterval: 3, gate: 1 }],
                waveGold: 100,
                waveTime: 200,
                hpMultiplier: 4,
            },
    ...
    // 世界5-困难
    {
        waves: [
            {
                enemies: [{ type: 1028, count: 15, spawnInterval: 5, gate: 0 },{ type: 1027, count: 15, spawnInterval: 5, gate: 1 }],
                waveGold: 300,
                waveTime: 30,
                hpMultiplier: 1.5,
            },
            {
                enemies: [{ type: 1034, count: 5, spawnInterval: 4, gate: 0 },{ type: 1033, count: 5, spawnInterval: 4, gate: 1 }],
                waveGold: 200,
                waveTime: 30,
                hpMultiplier: 2,
            },
            {
                enemies: [{ type: 1027, count: 10, spawnInterval: 3, gate: 0 }],
                waveGold: 100,
                waveTime: 10,
                hpMultiplier: 2,
            },
            ...
            {
                enemies: [{ type: 1030, count: 40, spawnInterval: 1, gate: 0 },{ type: 1030, count: 30, spawnInterval: 1, gate: 1 }],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 3,
            },
            ...
            {
                enemies: [{ type: 1014, count: 3, spawnInterval: 8, gate: 0 },{ type: 1032, count: 3, spawnInterval: 8, gate: 1 }],
                waveGold: 100,
                waveTime: 400,
                hpMultiplier: 10,
            },
