...
export default class GameServiceConfig {
     ...
     * 进入战场体力消耗值.
     */
    public static readonly STAMINA_COST_ENTER_FIGHTING = 100;
     ...
     * 最大登录记录统计数量.
     */
    public static readonly MAX_LOGIN_RECORD_STATISTIC_COUNT = 50;
    //#endregion ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠐⠒⠒⠒⠒⠚⠛⣿⡟⠄⠄⢠⠄⠄⠄⡄⠄⠄⣠⡶⠶⣶⠶⠶⠂⣠⣶⣶⠂⠄⣸⡿⠄⠄⢀⣿⠇⠄⣰⡿⣠⡾⠋⠄⣼⡟⠄⣠⡾⠋⣾⠏⠄⢰⣿⠁⠄⠄⣾⡏⠄⠠⠿⠿⠋⠠⠶⠶⠿⠶⠾⠋⠄⠽⠟⠄⠄⠄⠃⠄⠄⣼⣿⣤⡤⠤⠤⠤⠤⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
     ...
     * 场景名称.
     */
    public static readonly SCENE_NAME = "fight";
