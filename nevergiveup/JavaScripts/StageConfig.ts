...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界3-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1033, count: 15, spawnInterval: 7 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 1.5,
            },
            ...
            {
                enemies: [{ type: 1032, count: 5, spawnInterval: 10 }],
                waveGold: 150,
                waveTime: 50,
                hpMultiplier: 6,
            },
            ...
            {
                enemies: [{ type: 1034, count: 10, spawnInterval: 10 }],
                waveGold: 100,
                waveTime: 300,
                hpMultiplier: 8,
            },
    ...
    // 世界3-困难
    {
        waves: [
            ...
            {
                enemies: [{ type: 1034, count: 10, spawnInterval: 3 }],
                waveGold: 150,
                waveTime: 20,
                hpMultiplier: 3.2,
            },
            {
                enemies: [{ type: 1032, count: 3, spawnInterval: 3 }],
                waveGold: 150,
                waveTime: 40,
                hpMultiplier: 6,
            },
            {
                enemies: [{ type: 1035, count: 15, spawnInterval: 3 }],
                waveGold: 0,
                waveTime: 30,
                hpMultiplier: 6,
            },
            {
                enemies: [{ type: 1039, count: 12, spawnInterval: 3 }],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 7,
            },
            {
                enemies: [{ type: 1037, count: 7, spawnInterval: 3 }],
                waveGold: 100,
                waveTime: 40,
                hpMultiplier: 7,
            },
            {
                enemies: [{ type: 1036, count: 6, spawnInterval: 3 }],
                waveGold: 0,
                waveTime: 400,
                hpMultiplier: 5,
            },
            {
                enemies: [{ type: 1032, count: 6, spawnInterval: 3 }],
                waveGold: 120,
                waveTime: 50,
                hpMultiplier: 6,
            },
            {
                enemies: [{ type: 1028, count: 20, spawnInterval: 3 }],
                waveGold: 120,
                waveTime: 50,
                hpMultiplier: 8,
            },
            {
                enemies: [{ type: 1026, count: 8, spawnInterval: 3 }],
                waveGold: 120,
                waveTime: 50,
                hpMultiplier: 8,
            },
