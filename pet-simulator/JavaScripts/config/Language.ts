...
10000＜总能力值 -- 龙龙2阶收益buff + 龙龙2阶攻击buff */
	...
	/**1. 每个宠物攻击一次金币或钻石需要扣除1点体力。
2. 每30分钟，根据玩家品质和特殊化维度最高的5只宠物恢复体力，宠物的品质维度：普通=2，稀有=4；史诗=6，传说=8，神话=10，宠物的特殊化维度：普通=0，爱心=2，彩虹=4。宠物恢复体力的数量=该宠物品质维度+该宠物特殊化维度。
3. 单次恢复体力的上限为60点。
4. 当现有体力达到体力上限时，将不再随时间恢复体力。*/
