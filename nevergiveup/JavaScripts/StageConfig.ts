...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界1-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1035, count: 5, spawnInterval: 1 },{ type: 1036, count: 2, spawnInterval: 6 }],
                waveGold: 80,
                waveTime: 50,
                hpMultiplier: 0.6,
            },
    ...
    // 世界1-困难
    {
        waves: [
            ...
            {
                enemies: [{ type: 1039, count: 3, spawnInterval: 5 }],
                waveGold: 180,
                waveTime: 30,
                hpMultiplier: 1,
            },
    ...
    // 世界2-简单
    {
        waves: [
            ...
            {
                enemies: [{ type: 1012, count: 3, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 1,
            },
    ...
    // 世界2-困难
    {
        waves: [
            ...
            {
                enemies: [{ type: 1012, count: 5, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 9.6,
            },
            {
                enemies: [{ type: 1019, count: 3, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 7.2,
            },
            {
                enemies: [{ type: 1013, count: 3, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 12,
            },
