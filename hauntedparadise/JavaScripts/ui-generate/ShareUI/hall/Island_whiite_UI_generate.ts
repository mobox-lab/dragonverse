 ...
 @UIBind('UI/ShareUI/hall/Island_whiite_UI.ui')
 export default class Island_whiite_UI_Generate extends UIScript {
...
UIService['UI_Island_whiite_UI'] = Island_whiite_UI_Generate;