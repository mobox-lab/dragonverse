 ...
 * @internal
 */
class GodModGameConfigParamInput extends GodModParamInputBase {
    ...
    setCustomLabel(label) {
        this._input.setLabel(label ?? "config id");
    }
    get validated() {
...
export { GodModGameConfigParamInput as default };
//# sourceMappingURL=GodModGameConfigParamInput.js.map
