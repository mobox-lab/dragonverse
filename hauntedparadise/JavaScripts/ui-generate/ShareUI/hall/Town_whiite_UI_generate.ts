 ...
 @UIBind('UI/ShareUI/hall/Town_whiite_UI.ui')
 export default class Town_whiite_UI_Generate extends UIScript {
...
UIService['UI_Town_whiite_UI'] = Town_whiite_UI_Generate;