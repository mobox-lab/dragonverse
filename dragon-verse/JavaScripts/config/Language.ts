...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**缺少精灵球！神像拒绝了你！*/
	get hasNoDragonBall():ILanguageElement{return this.getElement(300073)};
