...
可以通过每日奖励获得娃娃机币！*/
	...
	/**是否购买娃娃机币？*/
	get BuyDollCoin_Text_1():ILanguageElement{return this.getElement(970)};
	/**娃娃机币不足！是否购买？*/
	get DollCoinNotEnough_Text_1():ILanguageElement{return this.getElement(971)};
