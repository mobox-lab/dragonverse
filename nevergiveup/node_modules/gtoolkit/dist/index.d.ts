declare module "gtoolkit" {
    ...
    class GToolkit {
        ...
        private _batchHandlerPool;
        private _repeatBatchHandlerPool;
         ...
         */
        isNullOrEmpty(textOrArray: ArrayLike<unknown> | null | undefined): textOrArray is (null | undefined);
        /**
         * is the value null or undefined.
         * @param value
         */
        isNullOrUndefined(value: unknown | null | undefined): value is (null | undefined);
        /**
         ...
         * @param func
         */
        unfold<F, UF>(data: F[], func: (data: F) => UF[]): UF[];
        /**
         ...
         */
        batchDo<TArg>(data: TArg, batchCallback: (data: TArg[]) => void, waitTime?: number, reTouch?: boolean, instantly?: boolean): number | undefined;
        /**
         * Performs a delayed batch operation.
         * @desc Collects incoming data items into a batch queue,
         ...
         * @return {number} timer id.
         */
        batchRepeatDo<Func extends Method>(data: Parameters<Func>, batchCallback: Func, waitTime?: number, reTouch?: boolean, instantly?: boolean): number | undefined;
        /**
         ...
         * @return {string[]}
         */
        getAllMember(obj: object, ignoreObjectProto?: boolean, ignoreConstructor?: boolean): string[];
        /**
         ...
         */
        findPropertyDescriptor(obj: unknown, prop: string): PropertyDescriptor | undefined;
        /**
         * angle to radius.
         * @param angle
         */
         ...
         * 最小 UI 安全透明度.
         */
        readonly MIN_SAFE_UI_RENDER_OPACITY: number;
        /**
         * mw 场景根对象 引用.
         * @type {mw.GameObject}
         * @private
         ...
         */
        manhattanDistance<T extends number[] | AnyPoint>(a: T, b?: T): number;
        /**
         ...
         * @param b
         */
        squaredEuclideanDistance<T extends number[] | AnyPoint>(a: T, b?: T): number;
        /**
         * Euclid Distance.
         * 欧几里得距离.
         ...
         * @param b
         */
        euclideanDistance<T extends number[] | AnyPoint>(a: T, b?: T): number;
        /**
         * Manhattan Distance.
         * 曼哈顿距离.
         * 当 b 为 undefined 时 将 a 视为向量. 并计算其长度平方.
         */
        manhattanDistance2(a: IPoint2, b?: IPoint2): number;
        /**
         * Squared Euclid Distance.
         * 两点欧几里得距离的平方.
         * 当 b 为 undefined 时 将 a 视为向量. 并计算其长度平方.
         ...
         * @param b
         */
        squaredEuclideanDistance2(a: IPoint2, b?: IPoint2): number;
        /**
         * Euclid Distance.
         * 欧几里得距离.
         * 当 b 为 undefined 时 将 a 视为向量. 并计算其长度.
         ...
         * @param b
         */
        euclideanDistance2(a: IPoint2, b?: IPoint2): number;
        /**
         * Manhattan Distance.
         * 曼哈顿距离.
         * 当 b 为 undefined 时 将 a 视为向量. 并计算其长度平方.
         */
        manhattanDistance3(a: IPoint3, b?: IPoint3): number;
        /**
         * Squared Euclid Distance.
         * 两点欧几里得距离的平方.
         * 当 b 为 undefined 时 将 a 视为向量. 并计算其长度平方.
         ...
         * @param b
         */
        squaredEuclideanDistance3(a: IPoint3, b?: IPoint3): number;
        /**
         * Euclid Distance.
         * 欧几里得距离.
         * 当 b 为 undefined 时 将 a 视为向量. 并计算其长度.
         ...
         * @param b
         */
        euclideanDistance3(a: IPoint3, b?: IPoint3): number;
        /**
         ...
         * @param player
         */
        queryPlayer(player: number | string | Player): mw.Player | undefined;
        /**
         * 获取角色胶囊体 下圆心坐标.
         * @param character
         */
         ...
         *      - null 或 undefined 无限遍历.
         */
        getUiChildren<Item = mw.Widget>(widget: mw.Widget, traverse?: number): Item[];
        /**
    ...
    export class RandomGenerator {
         ...
         * @return {this}
         */
        randomCircle(randomFunc?: () => number): this;
        /**
    ...
    export class RevisedInterval {
         ...
         */
        constructor(_callback: () => void, _interval: number, delay?: number, instant?: boolean);
     ...
     */
    export function SingleFrameCache(dirtyPred?: () => boolean): (target: any, propertyKey: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
    export class SimulatedWorldTransform implements ITransform {
        parent: mw.GameObject | undefined;
        localPos: IPoint3;
        private _cached;
        get position(): IPoint3;
        set position(pos: IPoint3);
        constructor(pos: IPoint3, parent: mw.GameObject | undefined);
    }
