...
import Log4Ts from '../depend/log4ts/Log4Ts.js';
...
class Dialogue extends Component {
    constructor() {
        ...
        this.onPress = new Delegate.SimpleDelegate();
        this.onRelease = new Delegate.SimpleDelegate();
        //#endregion ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠐⠒⠒⠒⠒⠚⠛⣿⡟⠄⠄⢠⠄⠄⠄⡄⠄⠄⣠⡶⠶⣶⠶⠶⠂⣠⣶⣶⠂⠄⣸⡿⠄⠄⢀⣿⠇⠄⣰⡿⣠⡾⠋⠄⣼⡟⠄⣠⡾⠋⣾⠏⠄⢰⣿⠁⠄⠄⣾⡏⠄⠠⠿⠿⠋⠠⠶⠶⠿⠶⠾⠋⠄⠽⠟⠄⠄⠄⠃⠄⠄⣼⣿⣤⡤⠤⠤⠤⠤⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
    }
    ...
    static create(option) {
        ...
        dialogue.onAttach.add(() => {
            ...
            Gtk.setUiPosition(dialogue.root, (viewPortSize.x - dialogue.root.size.x) / 2 + (viewPortAbsPos.x - posParAbs.x) / mw.getViewportScale(), (viewPortSize.y - dialogue.root.size.y) / 2 + (viewPortAbsPos.y - posParAbs.y) / mw.getViewportScale());
            Gtk.setUiPosition(dialogue._btnModal, -(viewPortSize.x - dialogue.root.size.x) / 2, -(viewPortSize.y - dialogue.root.size.y) / 2);
        ...
        if (!dialogue._option.modal)
            dialogue._btnModal.onClicked.add(() => dialogue.close());
        ...
        dialogue._imgBack.margin = new mw.Margin(Lui.Asset.ImgRoundedRectangleBoxMargin.left, Lui.Asset.ImgRoundedRectangleBoxMargin.top, Lui.Asset.ImgRoundedRectangleBoxMargin.right, Lui.Asset.ImgRoundedRectangleBoxMargin.bottom);
        dialogue._txtTitle = mw.TextBlock.newObject(dialogue.root, "txtTitle");
        PropertyUtil.applyFontSize(dialogue._txtTitle, typeof dialogue._option.fontSize === "number" ?
        ...
        dialogue._txtTitle.setFontColorByHex(Lui.Asset.ColorUtil.colorHexWithAlpha(Lui.Asset.Color.Black, 1));
        ...
        dialogue._txtMessage.setFontColorByHex(Lui.Asset.ColorUtil.colorHexWithAlpha(Lui.Asset.Color.Gray900, 1));
    ...
    setLayout(option) {
        ...
        Gtk.setUiSize(this._txtTitle, contentX, Dialogue.DialogueTitleSizeY);
        Gtk.setUiPosition(this._txtMessage, pl + Dialogue.DialogueMessageLeftIndent, pt + +Dialogue.DialogueTitleSizeY);
        Gtk.setUiSize(this._txtMessage, contentX - Dialogue.DialogueMessageLeftIndent, contentY
        ...
        let lastPerWidth = Math.min(Math.max(0, contentX - sizedSum
            - Math.max(0, (this._option.feedbacks?.length ?? 0) - 1) * Dialogue.DialogueButtonSpace)
            / (this._option.feedbacks?.length ?? 1), Dialogue.DialogueButtonMaxSizeX);
...
//#region Constant
Dialogue.DialogueContentPaddingHorizontal = 50;
Dialogue.DialogueContentPaddingVertical = 30;
Dialogue.DialogueMessageLeftIndent = 30;
Dialogue.DialogueTitleSizeY = 80;
Dialogue.DialogueButtonPaddingTop = 20;
Dialogue.DialogueButtonSizeY = 60;
Dialogue.DialogueButtonMaxSizeX = 200;
Dialogue.DialogueButtonSpace = 10;
