...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界1-简单
    {
        waves: [
            {
                enemies: [{ type: 1040, count: 5, spawnInterval: 5 }],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 0.8,
            },
        ...
        waves: [
            ...
            },
            {
                enemies: [
                    ...
                    { type: 1025, count: 2, spawnInterval: 6, gate: 1 },
                ],
                waveGold: 100,
                waveTime: 20,
                hpMultiplier: 2,
        ...
        waves: [
            ...
            },
            {
                enemies: [
                    ...
                    { type: 1017, count: 4, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 100,
                waveTime: 25,
                hpMultiplier: 2,
        ...
        waves: [
            ...
            },
            {
                enemies: [
                    ...
                    { type: 1033, count: 1, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 100,
                waveTime: 10,
                hpMultiplier: 4,
            ...
            },
            {
                enemies: [
                    ...
                    { type: 1034, count: 15, spawnInterval: 3, gate: 1 },
                ],
                waveGold: 100,
                waveTime: 40,
                hpMultiplier: 2.5,
    ...
    // 世界5-普通
    {
        waves: [
            {
                enemies: [
                    { type: 1030, count: 25, spawnInterval: 2, gate: 0 },
                    { type: 1034, count: 8, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 400,
                waveTime: 30,
                hpMultiplier: 1.2,
            },
            {
                enemies: [
                    ...
                    { type: 1019, count: 1, spawnInterval: 20, gate: 1 },
                ],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 2,
        ...
        waves: [
            ...
            },
            {
                enemies: [
                    ...
                    { type: 1033, count: 5, spawnInterval: 4, gate: 1 },
                ],
                waveGold: 200,
                waveTime: 30,
                hpMultiplier: 2,
            ...
            },
            {
                enemies: [
                    ...
                    { type: 1030, count: 30, spawnInterval: 1, gate: 1 },
                ],
                waveGold: 100,
                waveTime: 30,
                hpMultiplier: 3,
