 ...
 @UIBind('UI/ShareUI/hall/Island_intro_UI.ui')
 export default class Island_intro_UI_Generate extends UIScript {
...
UIService['UI_Island_intro_UI'] = Island_intro_UI_Generate;