 ...
 @UIBind('UI/ShareUI/hall/Hallghostface_UI.ui')
 export default class Hallghostface_UI_Generate extends UIScript {
...
UIService['UI_Hallghostface_UI'] = Hallghostface_UI_Generate;