import HandbookPanel_Generate from "../../ui-generate/handbook/HandbookPanel_generate";
import { BagItemUnique, BagModuleC, HandbookItemUnique } from "../../module/bag/BagModule";
...
//#region Member
    ...
    private _scrollView: ScrollView<HandbookItemUnique, HandbookPanelItem>;
//#endregion ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠐⠒⠒⠒⠒⠚⠛⣿⡟⠄⠄⢠⠄⠄⠄⡄⠄⠄⣠⡶⠶⣶⠶⠶⠂⣠⣶⣶⠂⠄⣸⡿⠄⠄⢀⣿⠇⠄⣰⡿⣠⡾⠋⠄⣼⡟⠄⣠⡾⠋⣾⠏⠄⢰⣿⠁⠄⠄⣾⡏⠄⠠⠿⠿⠋⠠⠶⠶⠿⠶⠾⠋⠄⠽⠟⠄⠄⠄⠃⠄⠄⣼⣿⣤⡤⠤⠤⠤⠤⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
...
//#region Member init
        this.btnClose.onClicked.add(
            () => UIService.hide(HandbookPanel),
        );

        this._bagModule = ModuleService.getModule(BagModuleC);
        this._scrollView = new ScrollView<HandbookItemUnique, HandbookPanelItem>(
            this._bagModule.handbookYoact,
            HandbookPanelItem,
            this.mScrollView,
            undefined,
            true,
