 ...
 @UIBind('UI/ShareUI/props/BuildBuy_UI.ui')
 export default class BuildBuy_UI_Generate extends UIScript {
	...
	protected initButtons() {
		...
		this.btn_buyItem.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "BuildBuy_UI_btn_buyItem");
		})
		...
		this.btn_no.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "BuildBuy_UI_btn_no");
		})
...
UIService['UI_BuildBuy_UI'] = BuildBuy_UI_Generate;