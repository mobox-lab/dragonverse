...
declare module "mw-god-mod" {
    ...
    export default class GodModService extends GodModService_base {
        ...
        onConstruct(): void;
        addCommand<P extends AcceptableParamType>(label: string, paramType?: P, clientCmd?: (params: InferParamType<P>) => void, serverCmd?: (player: mw.Player, params: InferParamType<P>) => void, paramOption?: GodCommandParamOption<InferParamType<P>>, group?: string): this;
