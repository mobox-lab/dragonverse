declare module "mw-god-mod" {
    ...
    export type AcceptableParamType = "void" | "string" | "integer" | "number" | "vector" | "vector2" | "rotation" | ConfigBase<IElementBase> | object;
    export type InferParamType<P extends AcceptableParamType> = P extends "void" ? void : P extends "string" ? string : P extends "integer" ? number : P extends "number" ? number : P extends "vector" ? mw.Vector : P extends "vector2" ? mw.Vector2 : P extends "rotation" ? mw.Rotation : P extends ConfigBase<infer E> ? E : P extends object ? ValueTypeInEnum<P> : never;
    export type InferParamTypeForTransmit<P extends AcceptableParamType> = P extends "void" ? void : P extends "string" ? string : P extends "integer" ? number : P extends "number" ? number : P extends "vector" ? mw.Vector : P extends "vector2" ? mw.Vector2 : P extends "rotation" ? mw.Rotation : P extends ConfigBase<IElementBase> ? number : P extends object ? ValueTypeInEnum<P> : never;
...
declare module "mw-god-mod" {
    ...
    export type ClientCmdType<P extends AcceptableParamType> = (params: InferParamType<P>) => CmdResultType;
    export type ServerCmdType<P extends AcceptableParamType> = (player: mw.Player, params: InferParamType<P>) => CmdResultType;
    /**
    ...
    export class GodCommandItem<P extends AcceptableParamType> {
        label: string;
        paramType: P;
        clientCmd?: ClientCmdType<P>;
        serverCmd?: ServerCmdType<P>;
         ...
         */
        constructor(label: string, paramType: P, clientCmd?: ClientCmdType<P>, serverCmd?: ServerCmdType<P>, paramOption?: GodCommandParamOption<InferParamType<P>>, group?: string);
        /**
         * 是否 󰍹客户端命令.
         * @return {boolean}
         */
...
declare module "mw-god-mod" {
    ...
    export class GodModPanel extends Component {
        ...
        refreshCmdItems(items: GodCommandItem<AcceptableParamType>[]): void;
...
declare module "mw-god-mod" {
    ...
    export default class GodModService extends GodModService_base {
         ...
         */
        static readonly GodModCommandRunResultInServerEventName = "__GOD_MOD_COMMAND_RUN_RESULT_IN_SERVER_EVENT_NAME__";
        /**
         * God Mod 查询权限请求 事件名.
         */
         ...
         * @desc 仅服务器.
         */
        static readonly GodModUnauthorizedCallEventName = "__GOD_MOD_UNAUTHORIZED_CALL_EVENT_NAME__";
        ...
        onConstruct(): void;
        addCommand<P extends AcceptableParamType>(label: string, paramType?: P, clientCmd?: ClientCmdType<P>, serverCmd?: ServerCmdType<P>, paramOption?: GodCommandParamOption<InferParamType<P>>, group?: string): this;
        removeCommand(label: string): this;
         ...
         * @return {this}
         */
        addPreviewForGameConfig(gameConfig: object): this;
        /**
         * 是否 具有权限.
         * @desc 仅服务端.
         * @param {string} userId
