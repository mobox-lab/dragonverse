...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界3-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1022, count: 5, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 6,
            },
    ...
    // 世界3-困难
    {
        waves: [
            {
                enemies: [{ type: 1008, count: 5, spawnInterval: 5 }],
                waveGold: 200,
                waveTime: 30,
                hpMultiplier: 2.5,
            },
            ...
            {
                enemies: [{ type: 1014, count: 3, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 7.5,
            },
    ...
    // 世界4-普通
    {
        waves: [
            {
                enemies: [{ type: 1015, count: 5, spawnInterval: 5 }],
                waveGold: 200,
                waveTime: 30,
                hpMultiplier: 2.6,
            },
            ...
            {
                enemies: [{ type: 1017, count: 5, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 30,
                hpMultiplier: 7.8,
            },
