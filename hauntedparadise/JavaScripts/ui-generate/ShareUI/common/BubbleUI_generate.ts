 ...
 @UIBind('UI/ShareUI/common/BubbleUI.ui')
 export default class BubbleUI_Generate extends UIScript {
	...
	private horn_Internal: mw.Image
	public get horn(): mw.Image {
		if(!this.horn_Internal&&this.uiWidgetBase) {
			this.horn_Internal = this.uiWidgetBase.findChildByPath('MWCanvas_2147482460/horn') as mw.Image
		}
		return this.horn_Internal
	}
...
UIService['UI_BubbleUI'] = BubbleUI_Generate;