 ...
 @UIBind('UI/ShareUI/hall/En_HallName_UI.ui')
 export default class En_HallName_UI_Generate extends UIScript {
...
UIService['UI_En_HallName_UI'] = En_HallName_UI_Generate;