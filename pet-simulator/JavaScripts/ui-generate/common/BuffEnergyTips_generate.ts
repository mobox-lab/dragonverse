...
@UIBind('UI/common/BuffEnergyTips.ui')
export default class BuffEnergyTips_Generate extends UIScript {
	...
	public get title(): mw.TextBlock {
		if(!this.title_Internal&&this.uiWidgetBase) {
			this.title_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/Canvas/title') as mw.TextBlock
		}
