@UIBind("")
export default class MainPanel extends UIScript {
    ...
    protected onStart() {
        ...
        //找到对应的跳跃按钮
        const jumpBtn = this.uiWidgetBase.findChildByPath("RootCanvas/btnJump") as Button;
        const attackBtn = this.uiWidgetBase.findChildByPath("RootCanvas/btnAttack") as Button;
