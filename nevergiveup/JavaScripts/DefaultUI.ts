...
export default class DefaultUI extends UIScript {
    ...
    protected  onStart() {
		...
		const virtualJoystickPanel = this.uiWidgetBase.findChildByPath('RootCanvas/VirtualJoystickPanel') as VirtualJoystickPanel;
		...
		Event.addLocalListener("ResetJoyStick", () => {
			virtualJoystickPanel.resetJoyStick();
		})
