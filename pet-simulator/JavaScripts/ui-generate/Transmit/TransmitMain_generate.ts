...
export default class TransmitMain_Generate extends mw.UIScript {
	@UIWidgetBind('RootCanvas/Canvas_Main/ScrollBox/mWorldCanvas')
    public mWorldCanvas: mw.Canvas=undefined;
    @UIWidgetBind('RootCanvas/Canvas_Main/ScrollBox_1/mPointCanvas')
    public mPointCanvas: mw.Canvas=undefined;
    @UIWidgetBind('RootCanvas/Canvas_Main/mText_world')
