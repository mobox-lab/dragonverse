...
/// <reference path="../puerts/index.ts" />
declare module UE {
    //@ts-ignore
    ...
    export class TSizedDefaultAllocator<T> {
        constructor();
    ...
    export class FFloat16Color {
        constructor();

        static StaticClass(): Class;

    }
    export class UPackageMap {
        constructor();

        static StaticClass(): Class;

    }
    export class FIntVector4 {
        constructor();

        static StaticClass(): Class;

    }
    export class VectorRegister {
        constructor();

        static StaticClass(): Class;

    }
    export class ScalarRegister {
        constructor();

        static StaticClass(): Class;

    }
    export class FOutputDevice {
        constructor();
