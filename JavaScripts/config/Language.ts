...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**背包*/
	get MainFunction_001():ILanguageElement{return this.getElement(105001)};
	/**点我复位*/
	get MainFunction_002():ILanguageElement{return this.getElement(105002)};
	/**开始采集*/
