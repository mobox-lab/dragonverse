...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界3-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1042, count: 6, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 40,
                hpMultiplier: 2.5,
            },
            ...
            {
                enemies: [{ type: 1048, count: 15, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 40,
                hpMultiplier: 3,
            },
            {
                enemies: [{ type: 1051, count: 15, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 40,
                hpMultiplier: 5,
            },
            ...
            {
                enemies: [{ type: 1065, count: 15, spawnInterval: 5 }],
                waveGold: 150,
                waveTime: 50,
                hpMultiplier: 6,
            },
            ...
            {
                enemies: [{ type: 1045, count: 8, spawnInterval: 4 }],
                waveGold: 150,
                waveTime: 50,
                hpMultiplier: 20,
            },
    ...
    // 世界5-简单
    {
        waves: [
            ...
            {
                enemies: [
                    { type: 1043, count: 2, spawnInterval: 5, gate: 0 },
                    { type: 1049, count: 2, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 120,
                waveTime: 10,
                hpMultiplier: 3,
