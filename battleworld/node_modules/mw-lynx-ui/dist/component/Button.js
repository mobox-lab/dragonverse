...
import { Component, getClickPositionOnPlatform, overrideOption, extractLayoutFromOption } from './Component.js';
...
class Button extends Component {
    ...
    static create(option) {
        ...
        btn._btn.onPressed.add(() => {
            ...
            const clickAt = mw.absoluteToLocal(btn.root.cachedGeometry, clickAtAbs);
    ...
    setLayout(option) {
        ...
        const txtSize = {
            x: contentX - 2 * (Lui.Asset.ImgRoundedRectangleBoxMargin.left +
                Lui.Asset.ImgRoundedRectangleBoxMargin.right),
            y: contentY,
        };
        Gtk.setUiPosition(this._cnvClickAnim, pl, pt);
        Gtk.setUiSize(this._cnvClickAnim, contentX, contentY);
        ...
        if (this._icon) {
            ...
            Gtk.setUiPosition(this._option.icon.root, pl + (contentX - iconSize) / 2, pt + (contentY - iconSize) / 2);
        }
        else if (this._imgIcon) {
            Gtk.setUiSize(this._imgIcon, minContent, minContent);
            Gtk.setUiPosition(this._imgIcon, pl + (contentX - minContent) / 2, pt + (contentY - minContent) / 2);
        }
        else {
