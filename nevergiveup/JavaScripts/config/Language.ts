...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**飞行*/
	get MonsterSkill_5():ILanguageElement{return this.getElement(20446)};
	/**具有该技能的单位生命值归0时，在当前所处位置召唤{0}数量的{1}单位*/
	get MonsterSkillDesc_1():ILanguageElement{return this.getElement(20447)};
	/**具有该技能的单位，每秒会回复{0}的生命值*/
	get MonsterSkillDesc_2():ILanguageElement{return this.getElement(20448)};
	/**该单位生命值低于一半时，会获得{0}%的移动速度提升*/
	get MonsterSkillDesc_3():ILanguageElement{return this.getElement(20449)};
	/**该单位只能被具有“反隐”标签的单位攻击*/
	get MonsterSkillDesc_4():ILanguageElement{return this.getElement(20450)};
	/**该单位只能被具有“对空增伤”、“优先对空”标签的单位攻击*/
	get MonsterSkillDesc_5():ILanguageElement{return this.getElement(20451)};
	/**高*/
	get Setting_1():ILanguageElement{return this.getElement(20452)};
	/**低*/
	get Setting_2():ILanguageElement{return this.getElement(20453)};
