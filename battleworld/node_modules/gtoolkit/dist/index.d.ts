declare module "gtoolkit" {
    ...
    class GToolkit {
         ...
         * @param position
         */
        isPlatformAbsoluteInWidget(position: mw.Vector2, ui: Widget): boolean;
        /**
         * 获取 UI 空间下 控件的 计算后坐标.
         ...
         * @return {mw.Vector2}
         */
        getUiResolvedPosition(ui: Widget): mw.Vector2;
        /**
         * 获取 UI 空间下 控件的 计算后大小.
         * @desc 计算后大小将考虑父子关系的缩放.
         * @param {Widget} ui
         */
        getUiResolvedSize(ui: Widget): mw.Vector2;
        /**
         ...
         *      - null 或 undefined 无限遍历.
         */
        getUiChildren<Item = Widget>(object: Widget, traverse?: number): Item[];
        /**
         ...
         * @param {number} y
         */
        setUiPosition(ui: Widget, x: number, y: number): void;
        setUiPositionX(ui: Widget, x: number): void;
        setUiPositionY(ui: Widget, y: number): void;
        /**
         ...
         * @param {number} y
         */
        setUiSize(ui: Widget, x: number, y: number): void;
        setUiSizeX(ui: Widget, x: number): void;
        setUiSizeY(ui: Widget, y: number): void;
        /**
         ...
         * @param {number} y
         */
        setUiScale(ui: Widget, x: number, y: number): void;
        setUiScaleX(ui: Widget, x: number): void;
        setUiScaleY(ui: Widget, y: number): void;
        /**
    ...
    export class HyperText {
        ...
        private _length;
        get length(): number;
        static fromString(str: string, tag?: string, attr?: string): HyperText;
