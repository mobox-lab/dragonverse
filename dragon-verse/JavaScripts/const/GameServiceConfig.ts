...
export default class GameServiceConfig {
     ...
     * 跳子游戏 进度条时长.
     */
    public static readonly SCENE_JUMP_TO_SUBGAME_PROGRESS_DURATION = 3e3;
    /**
     * 宠物模拟器GameID
     */
    public static readonly PET_SIMULATOR_GAME_ID = "P_7ed509fb0f6d6fce8923e29942c5ce8c766e7742";
    //#endregion ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠐⠒⠒⠒⠒⠚⠛⣿⡟⠄⠄⢠⠄⠄⠄⡄⠄⠄⣠⡶⠶⣶⠶⠶⠂⣠⣶⣶⠂⠄⣸⡿⠄⠄⢀⣿⠇⠄⣰⡿⣠⡾⠋⠄⣼⡟⠄⣠⡾⠋⣾⠏⠄⢰⣿⠁⠄⠄⣾⡏⠄⠠⠿⠿⠋⠠⠶⠶⠿⠶⠾⠋⠄⠽⠟⠄⠄⠄⠃⠄⠄⣼⣿⣤⡤⠤⠤⠤⠤⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
}