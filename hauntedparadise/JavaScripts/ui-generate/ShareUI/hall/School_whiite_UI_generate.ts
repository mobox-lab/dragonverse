 ...
 @UIBind('UI/ShareUI/hall/School_whiite_UI.ui')
 export default class School_whiite_UI_Generate extends UIScript {
...
UIService['UI_School_whiite_UI'] = School_whiite_UI_Generate;