...
const EXCELDATA:Array<Array<any>> = [["id","bagId","qualityId","generationAreaId","existenceCount","existenceTime","generationInterval","successRate","hitPoint","resultAlgo"],["","","","","","","","","",""],[1,1,1,[0],20,3600,5,80,5,1]];
