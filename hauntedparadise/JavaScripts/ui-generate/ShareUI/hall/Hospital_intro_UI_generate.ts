 ...
 @UIBind('UI/ShareUI/hall/Hospital_intro_UI.ui')
 export default class Hospital_intro_UI_Generate extends UIScript {
...
UIService['UI_Hospital_intro_UI'] = Hospital_intro_UI_Generate;