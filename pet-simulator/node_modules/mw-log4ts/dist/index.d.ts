declare module "mw-log4ts" {
    ...
    class Log4Ts {
         ...
         * @param messages text.
         */
        log: (announcer: Announcer, ...messages: (LogString | Error | string | unknown)[]) => void;
        /**
         * debug warn.
         * @param announcer announcer with name.
         *      when null or undefined, will print as second indent.
         * @param messages text.
         */
        warn: (announcer: Announcer, ...messages: (LogString | Error | string | unknown)[]) => void;
        /**
         * debug error.
         * @param announcer announcer with name.
         *      when null or undefined, will print as second indent.
         * @param messages text.
         */
        error: (announcer: Announcer, ...messages: (LogString | Error | string | unknown)[]) => void;
        /**
         * 设置配置.
         * @param config
         */
