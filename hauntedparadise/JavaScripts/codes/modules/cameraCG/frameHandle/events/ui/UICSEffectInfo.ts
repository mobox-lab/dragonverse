...
import { EffectParams } from "../handles/EffectHandle";


export class UICSEffectInfo extends CSEffectInfoUI_Generate implements UIEvents {

    public data: EffectParams;
    ...
    setData(info: EventFrameInfo): void {
        this.data = JSON.parse(info.params) as EffectParams;
