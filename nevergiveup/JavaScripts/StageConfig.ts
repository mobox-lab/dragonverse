...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界3-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1045, count: 8, spawnInterval: 5 }],
                waveGold: 100,
                waveTime: 50,
                hpMultiplier: 20,
            },
    ...
    // 世界3-困难
    {
        waves: [
            ...
            {
                enemies: [{ type: 1029, count: 15, spawnInterval: 5 }],
                waveGold: 300,
                waveTime: 50,
                hpMultiplier: 2,
            },
            ...
            {
                enemies: [{ type: 1040, count: 15, spawnInterval: 5 }],
                waveGold: 120,
                waveTime: 60,
                hpMultiplier: 5,
            },
            {
                enemies: [{ type: 1066, count: 12, spawnInterval: 5 }],
                waveGold: 120,
                waveTime: 50,
                hpMultiplier: 4,
            },
            ...
            {
                enemies: [{ type: 1059, count: 1, spawnInterval: 5 }],
                waveGold: 0,
                waveTime: 400,
                hpMultiplier: 40,
            },
