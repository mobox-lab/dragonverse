...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**涌动之水*/
	get Main_Scene_Name1():ILanguageElement{return this.getElement(300039)};
	/**火炎地狱*/
	get Main_Scene_Name2():ILanguageElement{return this.getElement(300040)};
	/**天空树*/
	get Main_Scene_Name3():ILanguageElement{return this.getElement(300041)};
	/**荒野边疆*/
	get Main_Scene_Name4():ILanguageElement{return this.getElement(300042)};
	/**赐福天光*/
	get Main_Scene_Name5():ILanguageElement{return this.getElement(300043)};
	/**永眠之暗*/
	get Main_Scene_Name6():ILanguageElement{return this.getElement(300044)};
