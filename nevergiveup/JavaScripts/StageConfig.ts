...
export const NEW_STAGE_CONFIG: NewStageConfig[] = [
    ...
    // 世界1-普通
    {
        waves: [
            ...
            {
                enemies: [{ type: 1066, count: 10, spawnInterval: 1 }],
                waveGold: 100,
                waveTime: 50,
                hpMultiplier: 1,
            },
    ...
    // 世界1-困难
    {
        waves: [
            ...
            {
                enemies: [{ type: 1024, count: 10, spawnInterval: 2 }],
                waveGold: 10,
                waveTime: 30,
                hpMultiplier: 1.2,
            },
            ...
            {
                enemies: [{ type: 1034, count: 15, spawnInterval: 1 }],
                waveGold: 30,
                waveTime: 50,
                hpMultiplier: 3.5,
            },
    ...
    //5-2-5
            {
                enemies: [
                    { type: 1032, count: 3, spawnInterval: 5, gate: 0 },
                    { type: 1049, count: 3, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 150,
                waveTime: 35,
                hpMultiplier: 5,
    ...
    //5-2-6
            {
                enemies: [
                    { type: 1031, count: 3, spawnInterval: 5, gate: 0 },
                    { type: 1012, count: 3, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 150,
                waveTime: 20,
                hpMultiplier: 10,
    ...
    //5-2-8
            {
                enemies: [
                    { type: 1023, count: 5, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 150,
                waveTime: 35,
                hpMultiplier: 25,
    ...
    //5-2-9
            {
                enemies: [
                    ...
                    { type: 1032, count: 3, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 150,
                waveTime: 20,
                hpMultiplier: 15,
    ...
    //5-2-10
            {
                enemies: [
                    ...
                    { type: 1014, count: 3, spawnInterval: 5, gate: 1 },
                ],
                waveGold: 150,
                waveTime: 300,
                hpMultiplier: 20,
