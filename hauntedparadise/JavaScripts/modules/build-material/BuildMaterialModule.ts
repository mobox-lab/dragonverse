...
export class BuildMaterialUnique implements IUnique {
    ...
    public static arrayFromObject(data: BuildMaterialModuleData): BuildMaterialUnique[] {
        ...
        //     result.push(new BuildMaterialUnique(
        //         Number(key),
        //         element));
        // }
        return result;
...
export default class BuildMaterialModuleData extends JModuleData {
    //@Decorator.persistence()
    //public isSave: bool;
}

/**
 * BuildMaterial Module.
 * 建材模块.
 * ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠐⠒⠒⠒⠒⠚⠛⣿⡟
 * ⠄⠄⢠⠄⠄⠄⡄⠄⠄⣠⡶⠶⣶⠶⠶⠂⣠⣶⣶⠂⠄⣸⡿⠄
 * ⠄⢀⣿⠇⠄⣰⡿⣠⡾⠋⠄⣼⡟⠄⣠⡾⠋⣾⠏⠄⢰⣿⠁⠄
 ...
 */
export class BuildMaterialModuleC extends JModuleC<BuildMaterialModuleS, BuildMaterialModuleData> {
//#region Member
...
export class BuildMaterialModuleS extends JModuleS<BuildMaterialModuleC, BuildMaterialModuleData> {
//#region Member
    private _eventListeners: EventListener[] = [];
//#endregion ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠐⠒⠒⠒⠒⠚⠛⣿⡟⠄⠄⢠⠄⠄⠄⡄⠄⠄⣠⡶⠶⣶⠶⠶⠂⣠⣶⣶⠂⠄⣸⡿⠄⠄⢀⣿⠇⠄⣰⡿⣠⡾⠋⠄⣼⡟⠄⣠⡾⠋⣾⠏⠄⢰⣿⠁⠄⠄⣾⡏⠄⠠⠿⠿⠋⠠⠶⠶⠿⠶⠾⠋⠄⠽⠟⠄⠄⠄⠃⠄⠄⣼⣿⣤⡤⠤⠤⠤⠤⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
