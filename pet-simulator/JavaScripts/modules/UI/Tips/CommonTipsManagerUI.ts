import CommonTipsPosUI_Generate from "../../../ui-generate/Buy/CommonTipsPosUI_generate";
import P_CommonTips from "./P_CommonTips";
 ...
 */
export default class CommonTipsManagerUI extends CommonTipsPosUI_Generate {
    ...
    public showTips(content: string): void {
        this.showSpecialTips(content, P_CommonTips);
    }
