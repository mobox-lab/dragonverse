...
declare module "mw-lynx-ui" {
    ...
    export abstract class Component {
        ...
        onDestroy: Delegate.SimpleDelegate<void>;
    }
...
declare module "mw-lynx-ui" {
    ...
    export class TextField extends Component {
        ...
        private _validated;
        private _selfCommitted;
        private _commitTypeCache;
        get text(): string;
...
declare module "mw-lynx-ui" {
    ...
    export class AutoComplete<IT extends AutoCompleteItem> extends Component {
        ...
        private refreshRealCommitTimer;
        private inferChoose;
...
declare module "mw-lynx-ui" {
    ...
    export class Dialogue extends Component {
        static readonly DialogueContentPaddingHorizontal = 50;
        static readonly DialogueContentPaddingVertical = 30;
        static readonly DialogueMessageLeftIndent = 30;
        static readonly DialogueTitleSizeY = 80;
        static readonly DialogueButtonPaddingTop = 20;
        static readonly DialogueButtonSizeY = 60;
        static readonly DialogueButtonMaxSizeX = 200;
        static readonly DialogueButtonSpace = 10;
        private _btnModal;
        private _imgBack;
        private _txtTitle;
        private _txtMessage;
        private _btnList;
        private _option;
        static create(option?: DialogueOption): Dialogue;
        static defaultOption(option?: DialogueOption): Required<DialogueOption>;
        setLayout(option: DialogueOption): this;
        renderText(title?: string, message?: string): this;
        renderFeedbacks(feedbacks?: DialogueFeedback[]): this;
        close(): void;
        onClick: Delegate.SimpleDelegate<ClickEvent>;
        onPress: Delegate.SimpleDelegate<ClickEvent>;
        onRelease: Delegate.SimpleDelegate<ClickEvent>;
