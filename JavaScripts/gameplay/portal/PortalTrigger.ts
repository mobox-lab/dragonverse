...
//#region Member
    ...
    public isRefreshRotation: boolean = false;
...
//region Event Callback
    private onObjectEnter = (obj: GameObject): void => {
        if (GToolkit.isSelfCharacter(obj)) {
            this.transferPlayer(obj as Character);
        }
    };

    private transferPlayer(character: Character) {
        ...
        if (character) {
            ...
            if (player) {
                ...
                character.worldTransform = new Transform(
                    this.destination,
                    this.isRefreshRotation ? this.endRotation : character.worldTransform.rotation,
                    character.worldTransform.scale,
                );

                if (this.isHoldVelocity) {
                    let v = this.isRefreshRotation ?
