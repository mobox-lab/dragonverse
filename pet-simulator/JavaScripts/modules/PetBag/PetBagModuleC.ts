...
export class PetBagModuleC extends ModuleC<PetBagModuleS, PetBagModuleData> {
    ...
    protected onStart(): void {
        ...
        this.trainChange();
        this.devInit();
        TimerModuleUtils.addOnlineDayListener(() => this.clearFuseToday(1), this);
        TimerModuleUtils.addLoginDayListener(() => this.clearFuseToday(2), this);
    }
    ...
    public clearFuseToday(x:number) {
        console.log(`#P12 ${x === 1? 'onlineListener': 'loginListener'} 今日合成次数刷新`);
