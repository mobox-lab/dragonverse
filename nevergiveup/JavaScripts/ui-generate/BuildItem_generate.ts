...
export default class BuildItem_Generate extends UIScript {
	...
	public get imgElement(): mw.Image {
		if(!this.imgElement_Internal&&this.uiWidgetBase) {
			this.imgElement_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvasElement/imgElement') as mw.Image
		}
	...
	public get textElement(): mw.TextBlock {
		if(!this.textElement_Internal&&this.uiWidgetBase) {
			this.textElement_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvasElement/textElement') as mw.TextBlock
		}
