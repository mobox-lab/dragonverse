...
//#region Data Storage
     ...
     */
    async querySceneGameModuleData(moduleDataName: string, userId: string, defaultValue: string = ""): Promise<string> {
     ...
     */
    async updateSceneGameModuleData(moduleDataName: string, userId: string, value: string): Promise<boolean> {
