declare module "mw-god-mod" {
    ...
    class ConfigBase<T extends IElementBase> {
    ...
    export type InferParamType<P> = P extends "void" ? void : P extends "string" ? string : P extends "integer" ? number : P extends "number" ? number : P extends "vector" ? mw.Vector : P extends ConfigBase<IElementBase> ? number : P extends object ? ValueTypeInEnum<P> : never;
