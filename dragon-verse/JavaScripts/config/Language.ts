...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**喲，新來的冒險家！歡迎來到Dragonverse Neo，這裡可是個充滿奇妙的世界。看到地上那些五光十色的物體了嗎？那可是我們這裡的寶貝Blue Snitch。*/
	...
	/**沒錯！Blue Snitch是這片大陸上獨有的特產。你可以用它們來捕捉Modragon，也能用來合成一些有趣的東西。來，我教你如何辨認Blue Snitch。*/
	get Dialogue0012():ILanguageElement{return this.getElement(200004)};
	/**這些Blue Snitch有不同的顏色和紋理，代表著它們的不同稀有度，越稀有的Blue Snitch捕獲成功率越高。*/
	...
	/**僅此一家，也只有在Dragonverse Neo中你才能體會到這種樂趣了！去吧，嘗試著採集一些Blue Snitch,火龍果和金幣吧。*/
	...
	/**你倒是很坦誠嘛！其實，只需要使用Blue Snitch就可以捕捉到屬於你的Dragon了。先來瞭解一下如何使用Blue Snitch吧。*/
	get Dialogue0027():ILanguageElement{return this.getElement(200019)};
	/**看到這顆Blue Snitch了嗎？你可以通過Modragon捕獲面板的操縱杆，選擇它，然後投擲到想要捕捉的Modragon附近。不過，這可不是一件簡單的事情，每個Modragon都有自己的個性。*/
	...
	/**比如說Blue Snitch，這是這片大陸上獨有的特產，你可以用它們來捕捉Modragon。當然還有火龍果，你的龍娘寶寶們可全靠它吃飽肚子！*/
	...
	/**利用你的捕捉操縱杆即可，不過首先你要確保你的背包裡有Blue Snitch*/
	...
	/**可沒那麼容易，想要提高你的捕捉成功率，你必須在完美區域釋放你的Blue Snitch。性格不好的龍娘尤其難抓！*/
	...
	/**沒錯，每個龍娘都有自己的性格。多觀察龍娘頭頂的性格，不要浪費自己的Blue Snitch哦！*/
	...
	/**樱之森*/
	get Main_Scene_Name7():ILanguageElement{return this.getElement(300055)};
	/**绿洲*/
	get Main_Scene_Name8():ILanguageElement{return this.getElement(300056)};
	/**河畔小巷*/
	get Main_Scene_Name9():ILanguageElement{return this.getElement(300057)};
	/**覆潮之下*/
	get Main_Scene_Name10():ILanguageElement{return this.getElement(300058)};
	/**梦幻乐园*/
	get Main_Scene_Name11():ILanguageElement{return this.getElement(300059)};
	/**鲸落*/
	get Main_Scene_Name12():ILanguageElement{return this.getElement(300060)};
	/**巫师豪宅*/
	get Main_Scene_Name13():ILanguageElement{return this.getElement(300061)};
	/**勘察站*/
	get Main_Scene_Name14():ILanguageElement{return this.getElement(300062)};
	/**无人边境*/
	get Main_Scene_Name15():ILanguageElement{return this.getElement(300063)};
	/**温泉旅店*/
	get Main_Scene_Name16():ILanguageElement{return this.getElement(300064)};
	/**寻常一角*/
	get Main_Scene_Name17():ILanguageElement{return this.getElement(300065)};
	/**水晶洞穴*/
	get Main_Scene_Name18():ILanguageElement{return this.getElement(300066)};
	/**炼狱城堡*/
	get Main_Scene_Name19():ILanguageElement{return this.getElement(300067)};
	/**高塔*/
	get Main_Scene_Name20():ILanguageElement{return this.getElement(300068)};
