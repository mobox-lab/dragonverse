 ...
 @UIBind('UI/ShareUI/hall/School_intro_UI.ui')
 export default class School_intro_UI_Generate extends UIScript {
...
UIService['UI_School_intro_UI'] = School_intro_UI_Generate;