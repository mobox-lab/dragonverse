...
class GMService {
    ...
    async getAuthority(isTemporaryStorage, userId) {
        if (!this.isGetGMUserList) {
            ...
            const result = await DataStorage.asyncGetData("GM.UserList");
            if (result.code === DataStorageResultCode.Success) {
                const userList = result.data;
                if (!userList) {
                    DataStorage.asyncSetData("GM.UserList", []);
                }
                else {
